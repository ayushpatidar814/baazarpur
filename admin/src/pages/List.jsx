  ...
  return (
    <div>
        ...
        <div className='flex flex-col gap-2'>
            ...
            {
                list.map((item, key) => (
                    <div className='grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-2 py-1 px-2 border text-sm' key={key}>
                        <img src={item.image[0]} alt="product images" className="w-12" />
                        <p>{item.name}</p>
                        <p>{item.category}</p>
