...
const PlaceOrder = () => {
  ...
  return ( 
    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      {/* ----------- Left Side ----------- */}
      {
        editMode ? <EditProfileDetails setEditMode={setEditMode} text1={'Billing & Shipping Addrress'} /> : <ProfileDetails setEditMode={setEditMode} profile={profile} setProfile={setProfile} text1={'Billing & Shipping Addrress'} text2={'Change Address'} /> 
        }
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full text-end mt-8">
            <button onClick={onSubmitHandler} className="bg-black text-white px-16 py-3 text-sm">PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
